    ...
    async checkDevices() {
        for await (const device of this.GetDevices() || []) {
            ...
            await this.setObjectNotExistsAsyncEasy(
                ...
                parseFloat(deviceInfo.parameter.temperature_In.replace(',', '.')),
                'number',
                'indicator',
                true,
                false,
            ...
            await this.setObjectNotExistsAsyncEasy(
                ...
                parseFloat(deviceInfo.parameter.temperature_Out.replace(',', '.')),
                'number',
                'indicator',
                true,
                false,
            ...
            await this.setObjectNotExistsAsyncEasy(
                ...
                parseFloat(deviceInfo.parameter.temperature_Fresh.replace(',', '.')),
                'number',
                'indicator',
                true,
                false,
            ...
            await this.setObjectNotExistsAsyncEasy(
                ...
                parseFloat(deviceInfo.parameter.rel_Humidity_In.replace(',', '.')),
                'number',
                'indicator',
                true,
                false,
            ...
            await this.setObjectNotExistsAsyncEasy(
                ...
                parseFloat(deviceInfo.parameter.rel_Humidity_Out.replace(',', '.')),
                'number',
                'indicator',
                true,
                false,
            ...
            await this.setObjectNotExistsAsyncEasy(
                ...
                parseFloat(deviceInfo.parameter.abs_Humidity_In.replace(',', '.')),
                'number',
                'indicator',
                true,
                false,
            ...
            await this.setObjectNotExistsAsyncEasy(
                ...
                parseFloat(deviceInfo.parameter.abs_Humidity_Out.replace(',', '.')),
                'number',
                'indicator',
                true,
                false,
            ...
            await this.setObjectNotExistsAsyncEasy(
                ...
                parseFloat(deviceInfo.parameter.efficiency.replace(',', '.')),
                'number',
                'indicator',
                true,
                false,
